...
We have addressed reviewer comments below and made a number of changes to better explain our demographic parameters and alternate factors affecting GWAS transferability. Included here is a combined PDF including the revised text and response to reviewers, and a diff file comparing this revision and our previous submission (note that page and line numbers in the response to reviewers refers to the revised text, not the diff file). Thank you for your time and efforts.    
