...
\reply{
   We have added additional discussion of this point to appendix A (see "Demographic Model") \llname{apx:demographic_model}
}
...
\reply{
    This is a good point also raised by other reviewers. We have added an Appendix comparing our model to a stepping-stone \llname{apx:stepping_stone}, rather than the spatial-Labmda-Fleming-Viot, because we think these are the most familiar and widely used class of spatial models. We find that many features of our model are well approximated by stepping-stone models, and that for statistics like $\theta_{\pi}$ the stepping stone model results approach our continuous space model as the number of demes used to describe the landscape increases. 
}
