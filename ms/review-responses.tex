...
\reply{
    We agree that not noting EEMS was an oversight. We have added the most recent EEMS paper to the citations on \llname{eemscitation}, and have added an Appendix giving a more thorough comparison with stepping-stone models. 
}
...
\reply{
	We have clarified the notation for the second instance (referring to the distance among individuals) to $d$. 
}
