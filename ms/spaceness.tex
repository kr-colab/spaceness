...
To avoid questionable assumptions, we here used forward-time, individual-based simulations.
The question of what regulates real populations has a long history and many answers
\citep{lloyd1967crowding,antonovics1980ecological},
but it is clear that populations must have some density-dependent feedback on population size,
...
\citep{slatkin1989comparison,barton2002neutral,robledoarnuncio2010isolation},
