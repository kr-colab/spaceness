...
using pyslim \citep{pyslim}.
 ...
 Note that $\sigma$ controls the dispersal of offspring away from only \emph{one} parent (e.g., the seed parent for plants),
...
To match theory, neighborhood size should be defined in terms of \emph{effective}
...
and \emph{effective} population density \citep{Rousset1997}.
...
\begin{figure}[htbp]
\centering
\includegraphics{final_figures/Fig1_sampling_maps.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{final_figures/Fig2_pop_params.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{final_figures/Fig3_runtimes.pdf}
...
\begin{figure*}[p]
\centering
\includegraphics[width=\textwidth]{final_figures/Fig4_sfs_w_sumstats_loglog.pdf}
...
\begin{figure*}[p]
\centering
\includegraphics[width=.5\textwidth]{final_figures/Fig5_ibs_cumdists_w_rm.pdf}
\caption{
...
\begin{figure*}[p]
\centering
\includegraphics[width=\textwidth]{final_figures/Fig6_distance_by_DAF.pdf}
\caption{
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{final_figures/Fig7_demography_rollmedian_w_variance.pdf}
...
\begin{figure*}[p]
\centering
\includegraphics[width=\textwidth]{final_figures/Fig8_gwas_summary_loglog_qqlines.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=\textwidth]{final_figures/FigA1_grid_ss_curves_edit.pdf}
